...
Lorsqu'un pair exécute une opération il dérive un message qui contient une différence d'états.
...
\emph{Dotted LogootSplit} a également moins d'hypothèse sur la livraison de messages.
