...
% On map ainsi directement à la strong spec avec quelques axiomes en plus tel que:
...
Un pair peut choisir une position entre toute pair de positions avec l'identifiant local.

\begin{definition}[Positions]\label{def:pos}
Soit $\trm{Pos}$ la famille des ensembles de positions.
Un ensemble $P$ est un ensemble de positions, et nous écrivons $P \in \trm{Pos}$, si et seulement s'il est équipé des relations et des fonctions suivantes~:
\begin{itemize}
...
Il est également transmis aux autres pairs qui l'intégreront à terme.
Lors de l'exécution de l'insertion d'une valeur $v$ avant la $n$-ème valeur, une position est choisie de manière à être comprise entre les positions de la $n-1$-ème valeur et la $n$-ème valeur.
