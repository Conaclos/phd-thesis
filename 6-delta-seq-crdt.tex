...
Pour respecter une spécification, les protocoles de réplication optimiste proposés dans la littérature mettent en œuvre différents stratégies.
...
La position générée est comprise entre le positions $p_1$ et $p_2$ des valeurs $v_1$ et $v_2$ entre lesquelles $v$ doit être insérée.
...
Bien que ce soit possible, \emph{LogootSplit} ne propose pas de fusionner les deux blocs s'ils deviennent contiguës.
