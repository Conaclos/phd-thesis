...
Cette contrainte a une implication intéressante~: si il existe une chaîne de visibilité $x \viseq y \viseq z$ et une opération $w$ concurrente à $x$ et non-linéaire avec $y$, alors $w$ ne peut pas être immédiatement visible à toute opération future de l'auteur de $z$ ne peuvent.
Dans l'exécution abstraite $A_1$ de la \autoref{fig:vfjc-malicious-obs}, si nous considérons la chaîne de visibilité $a_1 \viseq m_1 \viseq a_2$, nous pouvons en conclure qu'il ne peut y avoir une extension de $A_1$ dans laquelle une opération $m_2$ concurrente à $a_1$ et non-linéaire à $m_1$ est immédiatement visible à une opération $a_3$.
De même si nous considérons la chaîne $m_1 \viseq m_1 \viseq a_2$, nous pouvons en conclure qu'il ne peut y avoir une extension de $A_1$ dans laquelle $m_2$ est non-linéaire à $m_1$ et immédiatement visible à une opération $a_3$.
...
Pour rejeter toute opération concurrente à $x$ de $p_M$, chaque pair honnête doit observer au moins une opération de $p_M$ tel que $x$ est visible ou est égale à cette opération.
...
Dans le cas d'une exécution abstraite qui respecte le modèle de cohérence \ac{VFJC}, le concours de tous les pairs à l'exception des pairs évincés à terme est nécessaire pour stabiliser une opération.
...
Il permet de stabiliser des opérations avec le concours d'un sous-ensemble de pairs.
