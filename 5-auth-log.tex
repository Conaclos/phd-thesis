...
Dans la \autoref{fig:all-perm-enum}, nous proposons un algorithme qui traduit la construction mathématique de cet article.
...
L'algorithme de la \autoref{fig:convergent-stable} ajoute une optimisation.
