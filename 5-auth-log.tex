...
\begin{tikzpicture}
    ...
    \path node (a1) {$a_1$}
        ...
        to +(9*\hsep,0) node (c1) {$c_1$}
        to +(10*\hsep,0) node (b3) {$b_3$}
    ;
    % Dependency
    \foreach \src/\dest in {a1/a2,a2/b1,b1/a3,a3/m1,m1/a4,m1p/b2,b2/a5,c1/b3}
        \draw[pre] (\src) to (\dest);
    \draw[vis,bend right=22] (b1) to (m1p);
    \draw[vis,bend left=22] (a4) to (a5);
    \draw[vis,bend right=22] (m1p) to (c1);
    \draw[vis,bend left=22] (a5) to (b3);
\end{tikzpicture}
...
\begin{table}[ht]
    ...
    \begin{tabular}{ccccc}
        ...
        $a_2$ & $\tuple*{\trm{invite}, p_B}$ & $p_A$ & $2$ & $\set*{a_1}$ \\
        $b_1$ & $\tuple*{\trm{invite}, p_M}$ & $p_B$ & $1$ & $\set*{a_2}$ \\
        $a_3$ & $\tuple*{\trm{ack}}$ & $p_A$ & $3$ & $\set*{b_1}$ \\
        $m_1$ & $\tuple*{\trm{add}, 1}$ & $p_M$ & $1$ & $\set*{a_3}$ \\
        $a_4$ & $\tuple*{\trm{ack}}$ & $p_A$ & $4$ & $\set*{m_1}$ \\
        $m_1'$ & $\tuple*{\trm{invite}, p_C}$ & $p_M$ & $1$ & $\set*{b_1}$ \\
        $b_2$ & $\tuple*{\trm{add}, 2}$ & $p_B$ & $2$ & $\set*{m_1'}$ \\
        $a_5$ & $\tuple*{\trm{ack}}$ & $p_A$ & $5$ & $\set*{a_4,b_2}$ \\
        $c_1$ & $\tuple*{\trm{add}, 3}$ & $p_C$ & $1$ & $\set*{m_1'}$ \\
        $b_3$ & $\tuple*{\trm{add}, 4}$ & $p_B$ & $3$ & $\set*{a_5,c_1}$ \\
    \end{tabular}
...
\begin{tikzpicture}[every node/.style={}]
    ...
    to +(-5,0) node[
        ...
        \end{tikzpicture}}
    to +(-5,\vsepevt) node[
        label={above:\textbf{(2) Exécute $\trm{invite}(p_B)$}},
        label={below:$\trm{ackInvited} = \trm{invited}_J = \set*{p_A,p_B}$}
    ]{\begin{tikzpicture}
            \path node (a1) {$a_1$}
                to +(\hsep,0) node (a2) {$a_2$}
            ;
        ...
        \end{tikzpicture}}
    to +(3,0) node[
        label={above:\textbf{(3) Livre $b_2 = \tuple*{\trm{invite},p_M}$}},
        label={below:$\trm{ackInvited} = \set*{p_A,p_B} \quad \trm{invited}_J = \set*{p_A,p_B,p_M}$}
    ]{\begin{tikzpicture}
            \path node (a1) {$a_1$}
                to +(\hsep,0) node (a2) {$a_2$}
                to +(2*\hsep,0) node (b1) {$b_1$}
            ;
            % Dependency
            \foreach \src/\dest in {a1/a2,a2/b1}
                \draw[pre] (\src) to (\dest);
            % Label
            \node[draw, dashed, label=left:$J$, fit=(a1) (b1)]{};
        \end{tikzpicture}}
    to +(3,\vsepevt) node[
        label={above:\textbf{(4) Livre $m_1 = \tuple*{\trm{add},1}$}},
        label={below:$\trm{ackInvited} = \trm{invited}_J = \set*{p_A,p_B,p_M}$}
    ]{\begin{tikzpicture}
            \path node (a1) {$a_1$}
                to +(\hsep,0) node (a2) {$a_2$}
                to +(2*\hsep,0) node (b1) {$b_1$}
            ...
            ;
            % Dependency
            \foreach \src/\dest in {a1/a2,a2/b1,b1/a3,a3/m1}
                \draw[pre] (\src) to (\dest);
            % Label
    ...
    to +(0,2*\vsepevt) node[
        ...
        label={below:$\trm{ackInvited} = \set*{p_A,p_B,p_M} \quad \trm{invited}_J = \set*{p_A,p_B,p_M}$}
    ]{\begin{tikzpicture}
            \path node (a1) {$a_1$}
                to +(\hsep,0) node (a2) {$a_2$}
                to +(2*\hsep,0) node (b1) {$b_1$}
            ...
            \foreach \src/\dest in {a1/a2,a2/b1,b1/a3,a3/m1}
                \draw[pre] (\src) to (\dest);
            \draw[vis,bend right=17] (b1) to coordinate(b1m1p) (m1p);
            % Label
            \node[draw, dashed, label=left:$J$, fit=(a1) (b1m1p) (m1)]{};
            \node[draw, dashed, label=right:$\trm{pending}$, fit=(m1p)]{};
        \end{tikzpicture}}
    to +(0,3*\vsepevt) node[
        label={above:\textbf{(5) Livre $c_1 = \tuple*{\trm{add},3}$}},
        label={below:$\trm{ackInvited} = \trm{invited}_J = \set*{p_A,p_B,p_M}$}
    ]{\begin{tikzpicture}
            \path node (a1) {$a_1$}
                to +(\hsep,0) node (a2) {$a_2$}
            ...
            ;
            % Dependency
            \foreach \src/\dest in {a1/a2,a2/b1,b1/a3,a3/m1,m1/a4,m1p/c1}
                \draw[pre] (\src) to (\dest);
            \draw[vis,bend right=17] (b1) to coordinate(b1m1p) (m1p);
            % Label
            \node[draw, dashed, label=left:$J$, fit=(a1) (b1m1p) (m1)]{};
        ...
        \end{tikzpicture}}
    to +(0,4*\vsepevt) node[
        label={above:\textbf{(7) Livre $b_2 = \tuple*{\trm{add},2}$}},
        label={below:$\trm{ackInvited} = \set*{p_A,p_B,p_M} \quad \trm{invited}_J = \set*{p_A,p_B,p_M,p_C} \quad \trm{knownMalicious}_J = \set*{p_M}$}
    ]{\begin{tikzpicture}
            \path node (a1) {$a_1$}
                to +(\hsep,0) node (a2) {$a_2$}
                to +(2*\hsep,0) node (b1) {$b_1$}
            ...
            ;
            % Dependency
            \foreach \src/\dest in {a1/a2,a2/b1,b1/a3,a3/m1,m1/a4,m1p/b2}
                \draw[pre] (\src) to (\dest);
            \draw[vis,bend right=17] (b1) to coordinate(b1m1p) (m1p);
            \draw[vis,bend right=28] (m1p) to coordinate(m1pc1) (c1);
            % Label
            \node[draw, dashed, label=left:$J$, fit=(a1) (b1m1p) (m1pc1) (b2)]{};
            \node[draw, dashed, label=right:$\trm{pending}$, fit=(c1)]{};
        \end{tikzpicture}}
    to +(0,5*\vsepevt) node[
        label={above:\textbf{(7) Livre $b_3 = \tuple*{\trm{add},4}$}},
        label={below:$\trm{ackInvited} = \trm{invited}_J = \set*{p_A,p_B,p_M} \quad \trm{knownMalicious}_J = \set*{p_M}$}
    ]{\begin{tikzpicture}
            \path node (a1) {$a_1$}
                to +(\hsep,0) node (a2) {$a_2$}
                to +(2*\hsep,0) node (b1) {$b_1$}
            ...
            \draw[vis,bend left=28] (a5) to coordinate(a5b3) (b3);
            % Label
            \node[draw, dashed, label=left:$J$, fit=(a1) (b1m1p) (a4a5) (m1pc1) (a5b3) (b3)]{};
        \end{tikzpicture}}
        ;
...
\end{tikzpicture}
\caption[Exemple du journal d'un pair]{Exemple du journal du pair $p_A$.}\label{fig:full-log-protocol}
\end{figure}
