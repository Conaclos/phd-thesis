...
\index{structure-donnees-dependantes@Structure de données dépendantes}
...
La \autoref{def:exec-abs-log} définit l'exécution abstraite associée à un journal\index{execution-abstraite-associee@Exécution abstraite associée}.
