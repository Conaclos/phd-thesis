...
Pour détecter les équivoques et intégrer à leur copie l'ensemble des modifications effectuées sur le contenu, les pairs répliquent un \emph{journal authentifié}.
...
Un pair mal-intentionné ne peut donc pas prétendre qu'une modification a été effectuée par un pair honnête.
...
Nous contraignons l'acceptation des modifications dans un journal de telle manière à ce que les modifications acceptées ultérieurement partagent un ensemble croissant de dépendances.
Nous déterminons cet ensemble à l'aide du concept de \emph{stabilité}.
Au sein d'un journal, une modification devient stable une fois que toutes les modification ajoutées ultérieurement dans le journal dépendent de cette modification.
