...
\end{subfigure}
\caption{Exemple d'exécutions abstraites avec des opérations vfjc-stables (vfjcs) en présence d'un pair honnête $p_A$, et de deux pairs mal-intentionné $p_M$ et $p_G$.}\label{fig:vfjcs-two-malicious}
\end{figure}
...
Comme tout autre message du journal, un message d'invitation ne peut être supprimé du journal si les messages qui dépendent de ce message ne deviennent pas convergent-stables.
