...
Pour permettre la stabilisation de modifications, les pairs devraient accepter les modifications dans leur journal sous certaines conditions.
...
Pour définir la stabilité au sein d'une exécution abstraite, nous introduisons dans la \autoref{def:abstract-exec-extension} le concept d'extension d'une exécution abstraite.
Cette définition se repose sur le concept d'extension d'une histoire introduit dans la \autoref{subsec:consistency-spec-liveness-safety} du \autoref{ch:background}.
