...
\end{subfigure}
\caption[Exécution de deux opérations qui coïncident dans le temps par un pair mal-intentionné]{Mallory est une collaboratrice mal-intentionnée.
...
\end{subfigure}
\caption[Exécution abstraite qui ne respecte pas le modèle de cohérence causale]{Exemple d'équivoque.
