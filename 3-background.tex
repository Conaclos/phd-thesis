...
Lorsque la relation de visibilité est transitive, nous utilisons une représentation graphique plus lisible.
...
L'exécution abstraite $A_1$ respecte en revanche le modèle de cohérence \ac{VFJC}.}\label{fig:known-colluding-malicious}
\end{figure}
