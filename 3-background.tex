...
Une histoire vérifie une propriété de cohérence si et seulement s'il existe au moins une exécution abstraite qui la respecte.
...
\end{subfigure}
\caption[Exemples d'une exécution abstraite mal-formée et d'une exécution abstraite bien-formée]{Exemples d'une exécutions abstraite mal-formée et d'une exécution abstraite bien-formée.
...
%Nous suivrons cet ordre pour numéroter les opérations des pairs mal-intentionnés sauf s'il gène la compréhension d'un exemple.
...
% Une exécution abstraite respecte donc une propriété de vivacité si et seulement s'il existe une extension qui la respecte.
...
% Une histoire $H$ vérifie un modèle de cohérence $C$ si et seulement s'il existe une exécution abstraite $A \defeq \tuple*{H, \trm{vis}}$ tel que $A$ respecte $C$.
% \begin{equation*}
...
\begin{tikzpicture}
    ...
    \draw[pre,bend right=20] (m1) to (m3);
\end{tikzpicture}
\caption[Exemple d'une exécution abstraite qui ne respecte pas le modèle de cohérence \ac{VFJC}]{Exemple d'une exécution abstraite qui ne respecte pas le modèle de cohérence \ac{VFJC}.
