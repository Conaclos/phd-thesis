...
\begin{tikzpicture}
    ...
    \draw[pre,bend right=20] (m1) to (m3);
\end{tikzpicture}
\caption[Exemple d'une exécution abstraites qui ne respecte pas le modèle de cohérence \ac{VFJC}]{Exemple d'une exécution abstraite qui ne respecte pas le modèle de cohérence \ac{VFJC}.
...
Si un un pair est reconnu mal-intentionné en une opération $x$, alors une opération de ce pair ne peut être immédiatement visible à $x$.
