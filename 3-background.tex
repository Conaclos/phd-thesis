...
Le protocole $P$ garantit ainsi la propriété $p_1$ puisque chcune de ses histoires est associée à au moins une exécution abstraite qui la respecte.}\label{fig:hist-absexec}
\end{figure}
